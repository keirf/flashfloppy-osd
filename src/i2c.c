...
/* === I2C1: Communication to the host. === */
#define _BL (1u<<3)
#define _EN (1u<<2)
#define _RW (1u<<1)
#define _RS (1u<<0)
...
/* STM32 I2C peripheral for communication with host: i2c1. */
#define i2c i2c1
#define SCL 6
#define SDA 7

/* I2C error ISR for i2c1. */
#define I2C_ERROR_IRQ 32
void IRQ_32(void) __attribute__((alias("IRQ_i2c_error")));

/* I2C event ISR for i2c1. */
...
/* I2C custom protocol state for i2c1. */
...
/* Process I2C data coming from the host. Special OSD protocol enabled. */
...
/* Process incoming I2C commands from the host. Special OSD protocol
 * NOT enabled. */
...
/* Process incoming I2C data from the host. Special OSD protocol NOT enabled. */
...
/* Process incoming I2C stream from the host. Special OSD protocol
 * NOT enabled. */
...
/* Process incoming I2C stream from the host. */
void i2c_process(void)
{
    return i2c_osd_protocol ? ff_osd_process() : lcd_process();
}

/* Establish I2C communication with the host. */
void i2c_init(void)
{
    char *p;
...
/* === I2C2: Communication to a slave OSD. === */

/* STM32 I2C Master peripheral to communicate with slave OSD: i2c2 */
#define i2cm i2c2
#define SCL2 10
#define SDA2 11

/* I2C error ISR for i2c2. */
#define I2CM_ERROR_IRQ 34
void IRQ_34(void) __attribute__((alias("IRQ_i2cm_error")));
/* I2C event ISR for i2c2. */
...
/* Snapshot buffer of current display and start sending it asynchronously. */
...
/* Establish communication with slave OSD. */
